    ...
    <div>
        <div class="content-header">
            <ol class="breadcrumb m-0">
                ...
                <li class="breadcrumb-item"><router-link to="/doctors/appointments-day-schedule">Appointments</router-link></li>
                                                    ...
                                                    <table class="table table-striped table-bordered">
                                                        ...
                                                        <tbody>
                                                            <tr v-for="(counter, cID) in mcountlist" :key="'mc'+cID" :id="'row'+cID">
                                                                ...
                                                                <td>
                                                                    <model-select :options="medicines_doses"
                                                                            name="medicine[]['dtab']"
                                                                ...
                                                                <td>
                                                                    <model-select :options="medicines_instructions"
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr v-for="(stock, stk) in stocks" :key="stk" v-else>
                                            ...
                                            <td>{{ stock.stock }}</td>
                                            <td>{{ stock.selling_cost | formatOMR }}</td>
                                        </tr>
                                    </tbody>
                                </table>
    ...
    export default {
        data() {
            return {
                ...
                medstocks:[],
                form: new Form({
                        appointment_code: this.$route.params.id,
                        user_id:'',
                        dr_remark:'',
                        followup:'',
                        medicine__id:[],
                ...
                .then((data) => {
                    ...
                    swal.fire({
                        ...
                        type: 'success',
                            ...
                            this.$router.push('/doctors/appointments-day-schedule');
                        });
                    this.loader = false;
                })
                .catch(() => {

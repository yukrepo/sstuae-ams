    ...
    <div>
        <div class="content-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><router-link :to="'/appointments/courses/'+currentYear">Courses</router-link></li>
                <li class="breadcrumb-item"><router-link :to="'/appointments/courses/view/'+invoice.course_code">View</router-link></li>
            ...
            <div class="container-fluid">
                <div class="form-group">
                    <div class="button-group">
                        <router-link class="btn btn-sm btn-primary" :to="'/appointments/courses/view/'+invoice.course_code">View Course </router-link>
                        <router-link class="btn btn-sm btn-outline-secondary" :to="'/appointments/courses/'+currentYear">Courses List </router-link>

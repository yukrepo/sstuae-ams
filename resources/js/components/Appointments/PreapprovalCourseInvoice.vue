            ...
            <div id="printDiv">
                ...
                <section class="bodybox">
                    <div class="container introbox">
                        <h2>
                            <span>Pre Approval Invoice</span>
                            <p class="float-right text-right m-t-10 m-b-0" style="font-size:13px;"> Ref No #{{ activeID }} </p>
                        </h2>
                        <br>
                        <div class="row">
                            <div class="col-4">
                ...
                <section>
                    <div style="padding:15px">
                        <div>
                            <div class="text-left">PAYMENT STATUS - <strong>PENDING</strong></div>
                        </div>
                    </div>
                </section>
                <section>

...
class AppointmentsController extends Controller
{
       ...
       /*  if($type == 'c'): $atype = [1];
        elseif($type == 't'): $atype = [2];
            ...
            if(Auth::user()->admin_type_id == 2):
                return $table->select("$tablename.id", "$tablename.date", "$tablename.feedback", "$tablename.fsms",  "$tablename.ainvoice", "$tablename.created_at", "$tablename.appointment_code", "$tablename.start_timeslot", "$tablename.end_timeslot", "$tablename.status_id", "$tablename.appointment_type_id", "$tablename.user_id", 'statuses.status as status', 'statuses.text as status_text', 'statuses.css as status_css', 'visit_types.visit_type as visit_type', 'appointment_types.appointment_type as appointment_type',  'locations.clinic_name as location', 'user_profiles.first_name', 'user_profiles.last_name', 'treatments.treatment as reason')
                        ->join('statuses', 'statuses.id', '=', "$tablename.status_id")
                        ->join('visit_types', 'visit_types.id', '=', "$tablename.visit_type_id")
                        ->join('appointment_types', 'appointment_types.id', '=', "$tablename.appointment_type_id")
                        ->join('users', 'users.id', '=', "$tablename.user_id")
                ...
                return $table->select("$tablename.id", "$tablename.date", "$tablename.feedback", "$tablename.fsms", "$tablename.created_at", "$tablename.appointment_code", "$tablename.start_timeslot", "$tablename.end_timeslot",  "$tablename.user_id", "$tablename.status_id", "$tablename.appointment_type_id", 'statuses.status as status', 'statuses.text as status_text', 'statuses.css as status_css', 'visit_types.visit_type as visit_type', 'appointment_types.appointment_type as appointment_type',  'locations.clinic_name as location', 'user_profiles.first_name', 'user_profiles.last_name', 'doctors.name as doctor', 'treatments.treatment as reason')
                        ->join('statuses', 'statuses.id', '=', "$tablename.status_id")
                        ->join('visit_types', 'visit_types.id', '=', "$tablename.visit_type_id")
                        ->join('appointment_types', 'appointment_types.id', '=', "$tablename.appointment_type_id")
                        ->join('users', 'users.id', '=', "$tablename.user_id")
    ...
    public function getUpcomingsYearwise($year = null)
    {
        if($year):
            ...
            $table = $table->setTable('appointment'.$year.'s');
            $tablename = $table->getTable();
            return $table->select("$tablename.id", "$tablename.date", "$tablename.created_at", "$tablename.appointment_code", "$tablename.start_timeslot", "$tablename.end_timeslot",  "$tablename.user_id", "$tablename.course_id", "$tablename.appointment_type_id", 'statuses.status as status', 'statuses.css as status_css', 'visit_types.visit_type as visit_type', 'appointment_types.appointment_type as appointment_type',  'locations.clinic_name as location', 'user_profiles.first_name', 'user_profiles.last_name', 'doctors.name as doctor', 'treatments.treatment as reason')
                        ->join('statuses', 'statuses.id', '=', "$tablename.status_id")
                        ->join('visit_types', 'visit_types.id', '=', "$tablename.visit_type_id")
                        ->join('appointment_types', 'appointment_types.id', '=', "$tablename.appointment_type_id")
                        ->join('users', 'users.id', '=', "$tablename.user_id")
    ...
    public function getPersonalUpcomingsYearwise($year = null)
    {
        if($year):
            ...
            $table = $table->setTable('appointment'.$year.'s');
            $tablename = $table->getTable();
            return $table->select("$tablename.id", "$tablename.date", "$tablename.created_at", "$tablename.appointment_code", "$tablename.start_timeslot", "$tablename.end_timeslot",  "$tablename.user_id", "$tablename.course_id", "$tablename.appointment_type_id", 'statuses.status as status', 'statuses.css as status_css', 'visit_types.visit_type as visit_type', 'appointment_types.appointment_type as appointment_type',  'locations.clinic_name as location', 'user_profiles.first_name', 'user_profiles.last_name', 'treatments.treatment as reason')
                        ->join('statuses', 'statuses.id', '=', "$tablename.status_id")
                        ->join('visit_types', 'visit_types.id', '=', "$tablename.visit_type_id")
                        ->join('appointment_types', 'appointment_types.id', '=', "$tablename.appointment_type_id")
                        ->join('users', 'users.id', '=', "$tablename.user_id")
    ...
    public function getHistoryYearwise($year = null)
    {
        if($year):
            ...
            if(Auth::user()->admin_type_id == 2):
                ...
                return $table->select("$tablename.id", "$tablename.date", "$tablename.feedback", "$tablename.fsms", "$tablename.created_at", "$tablename.appointment_code", "$tablename.start_timeslot", "$tablename.end_timeslot", "$tablename.course_id", "$tablename.appointment_type_id", "$tablename.user_id", "$tablename.status_id",  'statuses.status as status', 'statuses.text as status_text', 'statuses.css as status_css', 'visit_types.visit_type as visit_type', 'appointment_types.appointment_type as appointment_type',  'locations.clinic_name as location', 'user_profiles.first_name', 'user_profiles.last_name',  'doctors.name as doctor', 'treatments.treatment as reason')
                        ->join('statuses', 'statuses.id', '=', "$tablename.status_id")
                        ->join('visit_types', 'visit_types.id', '=', "$tablename.visit_type_id")
                        ->join('appointment_types', 'appointment_types.id', '=', "$tablename.appointment_type_id")
                        ->join('users', 'users.id', '=', "$tablename.user_id")
                ...
                foreach ($treatments as $treatment) {
                    ...
                    if($price) {
                        ...
                        $return[] = ['treatment' => $treatment->name,
                                        ...
                                        'qty' => $treatment->days,
                                        'discount' => $discount,
                                        'subtotal' => $price->cost*$treatment->days,
                                        'total' => ($price->cost*$treatment->days) -  $discount ];
                        $total = $total + (($price->cost*$treatment->days) -  $discount);
                        $count++;
                        $d3 = '';
                        $d5 = '';
    ...
    public function historySearch(Request $request)
    {
        ...
        return $table->select("$tablename.id", "$tablename.date", "$tablename.created_at", "$tablename.feedback", "$tablename.fsms", "$tablename.appointment_code",  "$tablename.appointment_type_id", "$tablename.start_timeslot", "$tablename.end_timeslot", "$tablename.status_id",  "$tablename.user_id", 'statuses.status as status', 'statuses.css as status_css', 'visit_types.visit_type as visit_type', 'appointment_types.appointment_type as appointment_type',  'locations.clinic_name as location', 'user_profiles.first_name', 'user_profiles.last_name', 'doctors.name as doctor', 'treatments.treatment as reason')
                ->join('statuses', 'statuses.id', '=', "$tablename.status_id")
                ->join('visit_types', 'visit_types.id', '=', "$tablename.visit_type_id")
                ->join('appointment_types', 'appointment_types.id', '=', "$tablename.appointment_type_id")
                ->join('users', 'users.id', '=', "$tablename.user_id")

                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Todays Appointments
                            <small class="card-tools text-warning">Actions Required (Complete /Cancel)</small>
                        </h3>
                    </div>
                    ...
                    <div class="card-footer p-0">
                        <a href="" class="btn btn-block btn-warning border-radius-0">Action Required For Previous Appointments</a>
                    </div>
                </div>
            </div>
        </div>

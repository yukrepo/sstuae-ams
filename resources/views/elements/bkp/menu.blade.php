    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent" >
        ...
        <ul class="navbar-nav ml-auto icon-nav m-r-25">
            ...
            <li class="nav-item dropdown bg-primary">
                <a class="nav-link dropdown-toggle text-uppercase text-white profile-menu" data-toggle="dropdown" href="javascript:;" role="button" aria-haspopup="true" aria-expanded="false"> Welcome {{ Auth::user()->username }} </a>
                <div class="dropdown-menu">
                    <a class="dropdown-item" href="/settings/profile">
                        <i class="fas fa-user m-r-5"></i>  Profile
                    </a>
                    @if (Auth::user()->admin_type_id == 1)
                        <a class="dropdown-item"  href="javascript:;" data-toggle="modal" data-target="#switchModal">
                            <i class="fas fa-random m-r-5"></i> Switch Location
                        </a>
                    @endif

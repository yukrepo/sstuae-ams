...
class Appointments extends Model
{
    ...
    protected $fillable = [
        'location_id', 'followup_appointment', 'course_id', 'user_id', 'admin_id', 'appointment_type_id', 'appointment_code', 'treatment_id', 'date', 'start_timeslot', 'end_timeslot', 'user_remark', 'visit_type_id', 'doctor_id', 'second_doctor_id', 'room_id', 'medicines', 'tests', 'symptoms', 'therapies', 'oe_categories', 'diseases', 'diagnosis', 'drug_history', 'reminder_days', 'reminder_date', 'fsms', 'status_id', 'dr_remark', 'cancel_reason', 'activities', 'call_status', 'call_point', 'is_dummy', 'created_at', 'updated_at'];

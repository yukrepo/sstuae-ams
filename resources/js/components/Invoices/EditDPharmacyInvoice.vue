                ...
                <div class="py-1">
                    <div class="button-group">
                        <span class="float-right">
                            <a class="btn btn-sm btn-outline-secondary" :href="'/invoices/direct-pharmacy-invoices/'+currentYear">back To List </a>
                        </span>
                    </div>
                </div>
                <div class="row">
        ...
        methods: {
            ...
            getInvoice() {
                ...
                axios.get('/api/invoices/view/'+this.activeID).then(({ data }) => {
                    ...
                    axios.get('/api/customers/'+ this.invoice.user_id)

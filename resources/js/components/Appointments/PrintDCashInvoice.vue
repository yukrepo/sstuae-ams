    ...
    <div>
        <div class="content-header">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><router-link :to="'/appointments/direct-courses/'+currentYear">Courses</router-link></li>
                <li class="breadcrumb-item"><router-link :to="'/appointments/courses/direct-view/'+invoice.course_code">View</router-link></li>
            ...
            <div class="container-fluid">
                <div class="form-group">
                    <div class="button-group">
                        <router-link class="btn btn-sm btn-primary" :to="'/appointments/courses/direct-view/'+invoice.course_code">View Course </router-link>
                        <router-link class="btn btn-sm btn-outline-secondary" :to="'/appointments/direct-courses/'+currentYear">Courses List </router-link>
                                    ...
                                    <table class="grand-total m-0">
                                        <tbody>
                                            ...
                                            <tr style="font-weight: 600; color: #333; font-size: 1.18em;"  v-if="invoice.insurance_id == 1">
                                                <td class="unit"><b>NET PAYABLE</b>(A) :</td>
                            ...
                            <div style="padding:15px">
                                <div>
                                    ...
                                    <div class="notice text-left">
                                        ...
                                        <span v-else>{{invoice.payment_mode | capitalize }}</span>
                                        </div>
        ...
        methods: {
            ...
            getInvoice() {
                ...
                axios.get('/api/invoices/view/'+this.$route.params.id).then(({ data }) => {
                    ...
                    axios.get('/api/courses/view-direct-course/'+data.course_code).then(({ data }) => {
                        this.course = data;
